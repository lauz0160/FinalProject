...
public class Earth_Main extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.lyricIcon:
                startActivity(new Intent(Earth_Main.this, Song_Lyric_Main.class));
                break;
            case R.id.nasaImageIcon:
                startActivity(new Intent(Earth_Main.this, Image_Main.class));
                break;
            case R.id.nasaEarthIcon:
                startActivity(new Intent(Earth_Main.this, Earth_Main.class));
                break;
            case R.id.geoIcon:
                startActivity(new Intent(Earth_Main.this, Geo_Main.class));
                break;
            case R.id.helpIcon:
