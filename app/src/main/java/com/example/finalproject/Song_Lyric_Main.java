 ...
 */
public class Song_Lyric_Main extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_song_lyrics_main);
        ...
        btnSearch.setOnClickListener(btn -> startActivity(new Intent(Song_Lyric_Main.this, Song_Lyric_Main.class)));

        //Launches the favorites page if the user clicks on the favorites button
        Button btnFavorites = findViewById(R.id.btnViewFav);
        btnFavorites.setOnClickListener(btn -> startActivity(new Intent(Song_Lyric_Main.this, Song_Lyric_Main.class)));

        //Launches the last image search
        Button btnLastSearch = findViewById(R.id.btnLastSearch);
        btnLastSearch.setOnClickListener(btn -> {
            Intent last = new Intent(Song_Lyric_Main.this, Song_Lyric_Main.class);
            last.putExtra("last", "yes");
            startActivity(last);
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.FavIcon:
                startActivity(new Intent(Song_Lyric_Main.this, Song_Lyric_Main.class));
                break;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nasaImageIcon:
                startActivity(new Intent(Song_Lyric_Main.this, Image_Main.class));
                break;
            case R.id.nasaEarthIcon:
                startActivity(new Intent(Song_Lyric_Main.this, Earth_Main.class));
                break;
            case R.id.geoIcon:
                startActivity(new Intent(Song_Lyric_Main.this, Geo_Main.class));
                break;
            case R.id.helpIcon:
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
                alertDialogBuilder.setTitle("NASA Image Help");
                alertDialogBuilder.setMessage("To search for a new song click the first button" +
                        "\n\nTo see the list of favorites click the last button" +
                        "\n\nTo see the last song searched click on the last button" +
