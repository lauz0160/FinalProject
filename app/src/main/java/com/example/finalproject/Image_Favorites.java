 ...
 */
public class Image_Favorites extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myList.setOnItemClickListener((parent, view, position, id) -> {
            ...
            startActivity(new Intent(Image_Favorites.this, Earth_Fragment_Frame.class).putExtras(dataToPass));
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.FavIcon:
                startActivity(new Intent(Image_Favorites.this, Image_Favorites.class));
                break;
            case R.id.SearchIcon:
                startActivity(new Intent(Image_Favorites.this, Earth_Search.class));
                break;
            case R.id.HomeIcon:
